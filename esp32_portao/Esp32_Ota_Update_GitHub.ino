...
#define URL_fw_Version "https://raw.githubusercontent.com/gigahertzinformatica/ghic_cod1/main/esp32_30pin/bin_version.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/gigahertzinformatica/ghic_cod1/main/esp32_30pin/fw.bin"
...
int FirmwareVersionCheck(void) {
  ...
  if (httpCode == HTTP_CODE_OK) // if version received
  {
    ...
    if (payload.equals(FirmwareVer)) {
      Serial.printf("\nDispositivo já com versão atualizada:%s\n", FirmwareVer);
      return 0;
    } 
    else 
    {
